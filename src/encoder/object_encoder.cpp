...
uoffset_t ObjectEncoder::EncodeObject(const Object& obj, const LuaRef& luaTable)
{
...
uoffset_t ObjectEncoder::EncodeStruct(const Object& obj, const LuaRef& luaTable)
{
...
bool ObjectEncoder::EncodeStructToBuf(const Object& obj,
...
bool ObjectEncoder::CheckStructFields(const Object& obj, const LuaRef& luaTable)
{
	assert(obj.is_struct());
...
bool ObjectEncoder::EncodeStructFieldToBuf(const Field& field,
	const LuaRef& luaTable, uint8_t* pBuf)
{
	assert(pBuf);
...
void ObjectEncoder::EncodeStructElementToBuf(reflection::BaseType eType,
...
uoffset_t ObjectEncoder::EncodeTable(const Object& obj, const LuaRef& luaTable)
{
	assert(!obj.is_struct());
...
uoffset_t ObjectEncoder::EncodeVector(
...
bool ObjectEncoder::CacheFields(const Object& obj, const LuaRef& luaTable,
...
void ObjectEncoder::CacheField(const Field* pField, const LuaRef& luaValue,
	Field2Lua& rMapLuaRef, Field2Offset& rMapOffset)
{
	assert(pField);
...
void ObjectEncoder::AddElements(const Field2Lua& mapScalar)
{
...
void ObjectEncoder::AddElement(const Field& field, const LuaRef& elementValue)
{
	const reflection::Type& type = *field.type();
...
void ObjectEncoder::AddOffsets(const Field2Offset& mapOffset)
{
...
inline void ObjectEncoder::AddElement(uint16_t offset,
...
bool ObjectEncoder::CheckObjectField(const Field* pField, const string& sFieldName)
{
	if (!pField)
