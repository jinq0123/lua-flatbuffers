...
function test_encode_struct()
	...
	buf, err = lfb.encode("Test", {a=1, b=-129})
	assert(err == "integer field Test.b(-129) is out of range [-128, 127]")
	buf, err = lfb.encode("Test", {a=1, b=128})
	assert(err == "integer field Test.b(128) is out of range [-128, 127]")
